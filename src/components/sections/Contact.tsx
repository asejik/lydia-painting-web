...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Mocking an API call delay for now.
    // We will wire this up to EmailJS or n8n later.
    setTimeout(() => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-start">
          ...
          >
            ...
            <h3 className="text-3xl md:text-5xl font-heading font-bold text-brand-navy mb-6 leading-tight">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input required type="text" id="firstName" name="firstName" className="w-full px-4 py-3 rounded-lg border border-slate-300 bg-white focus:outline-none focus:ring-2 focus:ring-brand-orange focus:border-transparent transition-shadow font-sans text-slate-800" placeholder="John" />
                  </div>
                  <div className="space-y-2">
                    ...
                    <input required type="text" id="lastName" name="lastName" className="w-full px-4 py-3 rounded-lg border border-slate-300 bg-white focus:outline-none focus:ring-2 focus:ring-brand-orange focus:border-transparent transition-shadow font-sans text-slate-800" placeholder="Doe" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input required type="email" id="email" name="email" className="w-full px-4 py-3 rounded-lg border border-slate-300 bg-white focus:outline-none focus:ring-2 focus:ring-brand-orange focus:border-transparent transition-shadow font-sans text-slate-800" placeholder="john@company.com" />
                  </div>
                  <div className="space-y-2">
                    ...
                    <input required type="tel" id="phone" name="phone" className="w-full px-4 py-3 rounded-lg border border-slate-300 bg-white focus:outline-none focus:ring-2 focus:ring-brand-orange focus:border-transparent transition-shadow font-sans text-slate-800" placeholder="(555) 123-4567" />
                  </div>
                </div>

                <div className="space-y-2">
                  <label htmlFor="service" className="font-sans text-sm font-medium text-slate-700">Service of Interest</label>
                  <select id="service" name="service" className="w-full px-4 py-3 rounded-lg border border-slate-300 bg-white focus:outline-none focus:ring-2 focus:ring-brand-orange focus:border-transparent transition-shadow font-sans text-slate-800 appearance-none">
                ...
                <div className="space-y-2">
                  ...
                  <textarea required id="message" name="message" rows={4} className="w-full px-4 py-3 rounded-lg border border-slate-300 bg-white focus:outline-none focus:ring-2 focus:ring-brand-orange focus:border-transparent transition-shadow font-sans text-slate-800 resize-none" placeholder="Tell us about your envisioned future..." />
                </div>
